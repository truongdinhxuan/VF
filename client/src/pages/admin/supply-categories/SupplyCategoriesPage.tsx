...
const SupplyCategoriesPage = () => {
  ...
  const resource = usePaginatedResource<SupplyCategory, CategoryQuery>({ loader, initialQuery, loadErrorMessage: 'Không thể tải danh mục vật tư.' });
